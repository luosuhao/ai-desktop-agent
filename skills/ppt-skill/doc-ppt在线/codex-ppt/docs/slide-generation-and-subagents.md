...
- white-paper technical route / evidence-chain infographic
...
```json
{
  ...
  "style": {
    ...
    "visual_direction": "{same final style description for every slide; for research/report decks prefer white-paper technical-route infographic x academic think-tank report: modular cards, numbered pipelines, evidence chains, source table snapshots, compact framework diagrams, and relationship maps; not premium business keynote}",
    "color_palette": "pure white full-slide background; foreground components use only the fixed six-color system: primary deep red, dark burgundy, charcoal gray, medium gray, muted gold, and sand beige; never render color cards or color-code labels",
    "typography": "{clear Chinese report typography, restrained hierarchy, no slogan-like hero typography}",
    "texture_and_finish": "{clean white-paper/report finish; avoid glossy gradients, launch-event lighting, and dark tech texture}",
  ...
  "visual_elements": {
    "main_visual": "{technical route, evidence chain, framework diagram, relationship map, risk matrix, source table snapshot, dashboard cards, or other content-specific visual idea}",
    "supporting_elements": "{arrows, numbered step labels, cards, callouts, source/evidence boxes, restrained icons, labels}"
  },
  "constraints": [
    "The final image itself must contain the title and key points.",
    "All text must be readable and correctly spelled.",
    "Use a pure white full-slide background; do not put the slide on a dark/red outer background.",
    "Generated foreground design elements must use only the canonical six-color palette from assets/palettes/corporate-six.json.",
    "Do not use red or burgundy as a full-slide background or large dominant surface.",
    "Do not render color cards, color-code text, color names, filler microtext, fake UI chrome, or decorative menu icons.",
